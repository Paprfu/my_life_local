...
!function($) {
    ...
    ChartJs.prototype.init = function() {
        ...
        var lineChart = {
            ...
            labels: ["Január", "Február", "Marec", "Apríl", "Máj", "Jún", "Júl", "August", "September","Oktobér"],
            ...
            datasets: [
                {
                    ...
                    fill: true,
                    lineTension: 0.5,
                    backgroundColor: "rgba(226, 42, 111, 0.68)",
                    borderColor: "#e22a6f",
                    borderCapStyle: 'butt',
                    borderDash: [],
                    borderDashOffset: 0.0,
                    borderJoinStyle: 'miter',
                    pointBorderColor: "#e22a6f",
                    pointBackgroundColor: "#fff",
                    pointBorderWidth: 1,
                    pointHoverRadius: 5,
                    pointHoverBackgroundColor: "#e22a6f",
                    pointHoverBorderColor: "#6fb9ef",
                ...
                },
                {
                    ...
                    fill: true,
                    lineTension: 0.5,
                    backgroundColor: "rgba(38, 213, 216, 0.68)",
                    borderColor: "#24d5d8",
                    borderCapStyle: 'butt',
                    borderDash: [],
                    borderDashOffset: 0.0,
                    borderJoinStyle: 'miter',
                    pointBorderColor: "#1cdde0",
                    pointBackgroundColor: "#fff",
                    pointBorderWidth: 1,
                    pointHoverRadius: 5,
            ...
            datasets: [
                {
                    ...
                    borderColor: "#e22a6f",
                    borderWidth: 1,
                    hoverBackgroundColor: "#e22a6f",
                    hoverBorderColor: "#e22a6f",
