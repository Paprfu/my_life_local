...
!function (a) {
    ...
    function o(a, b) {
        var c = a.offset(), d = q(a), e = c.left + t(a, "border-left-width") + d.left - (b ? b.left : 0),
            f = c.top + t(a, "border-top-width") + d.top - (b ? b.top : 0);
        return {left: e, right: e + a[0].clientWidth, top: f, bottom: f + a[0].clientHeight}
    }

    function p(a, b) {
        var c = a.offset(), d = c.left + t(a, "border-left-width") + t(a, "padding-left") - (b ? b.left : 0),
    ...
    function Qa(c, e) {
        ...
        T.bindOptions(["lang", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (a, b, c, d, e, g, h) {
            ...
            var b, c = T.moment(a.toArray()), d = a.time() - c.time();
        ...
        var V, W, Y, Z, $, _, aa, ba = T.isFetchNeeded, ca = T.fetchEvents, da = T.fetchEventSources, ea = c[0],
            fa = {}, ga = 0, ha = [];
    ...
    function Ua() {
        ...
        function i(b, c) {
            ...
            if (g) a.isFunction(g) ? (U.pushLoading(), g.call(U, W.clone(), X.clone(), U.options.timezone, function (a) {
                ...
                if (h) {
                    ...
                    var n = a.extend({}, j || {}), o = ba(b.startParam, U.options.startParam),
                        p = ba(b.endParam, U.options.endParam), q = ba(b.timezoneParam, U.options.timezoneParam);
        ...
        function G(b, c, d) {
            ...
            if (c = c || W, d = d || X, b) if (b._recurring) {
        ...
        function J(b) {
            var c, d = U.options.businessHours, e = {
        ...
        function K(a, b) {
            var c = b.source || {}, d = ba(b.constraint, c.constraint, U.options.eventConstraint),
        ...
        function Q(a, b, c, d) {
            var e, f, g, h, i, j;
            if (null != b) {
                for (e = R(b), f = !1, h = 0; h < e.length; h++) if (S(e[h], a)) {
                    f = !0;
                    break
                }
                if (!f) return !1
            }
            for (g = U.getPeerEvents(a, d), h = 0; h < g.length; h++) if (i = g[h], T(i, a)) {
                if (c === !1) return !1;
        ...
        function S(a, b) {
            var c = a.start.clone().stripZone(), d = U.getEventEnd(a).stripZone();
        ...
        var W, X, Y = U.reportEvents, Z = {events: []}, $ = [Z], ca = 0, da = [];
    ...
    var Wa = a.fullCalendar = {version: "2.9.0", internalApiVersion: 4}, Xa = Wa.views = {};
    ...
    var $a = [ "pon", "ut", "str", "štv", "pia", "sob", "ned"],
    ...
    var ab, bb, cb, db = {}.hasOwnProperty, eb = /^\s*\d{4}-\d\d$/,
        fb = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        gb = b.fn, hb = a.extend({}, gb);
    Wa.moment = function () {
        return la(arguments)
    ...
    var lb = Wa.EmitterMixin = {
        ...
        isHidden: !0, options: null, el: null, margin: 10, constructor: function (a) {
            ...
            var b, c, d, e, f, g = this.options, h = this.el.offsetParent().offset(), i = this.el.outerWidth(),
                j = this.el.outerHeight(), k = a(window), l = m(this.el);
    ...
    var rb = qb.extend({
        ...
        buildDayDragListener: function () {
            var a, b, c = this, d = this.view, e = d.opt("selectable"), f = new rb(this, {
                scroll: d.opt("dragScroll"), interactionStart: function () {
                    a = f.origHit
                }, dragStart: function () {
                    d.unselect()
    ...
    tb.mixin({
        ...
        handleSegTouchStart: function (a, b) {
            var c, d = this.view, e = a.event, f = d.isEventSelected(e), g = d.isEventDraggable(e),
                h = d.isEventResizable(e), i = !1;
        ...
        buildSegResizeListener: function (a, b) {
            var c, d, e = this, f = this.view, i = f.calendar, j = a.el, k = a.event, l = i.getEventEnd(k),
    ...
    var xb = Wa.View = ya.extend(lb, mb, {
        ...
        el: null, scrollEl: null, overflowX: null, overflowY: null, constructor: function (a) {
    ...
    Xa.basic = {"class": Gb}, Xa.basicDay = {type: "basic", duration: {days: 1}}, Xa.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    ...
    }, Mb = 5, Nb = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
    return Xa.agenda = {
        "class": Jb,
        defaults: {
            allDaySlot: !0,
