...
$projects_done = Globals::$person->getProjects_Done(1);
$projects_undone = Globals::$person->getProjects_Done(0);
?>
    ...
    <div class="main-content">
            ...
            <div class="breadcrumb-wrapper row">
                ...
                <div class="col-12 col-lg-9 col-md-6">
                    <ol class="breadcrumb float-right">
                        <li><a href="?page=dashboard">User</a></li>
        ...
        <div class="container-fluid">
            <div class="card-group">
                <?php
                cardGroupItem('Number of projects', 'lni-pencil-alt', 'purple', count(Globals::$person->getProjects()), 0, 1000);
                cardGroupItem('Undone projects', 'lni-close', 'danger', count(Globals::$person->getProjects_Done(0)), 0, count(Globals::$person->getProjects()));
                cardGroupItem('Done projects', 'lni-check-box', 'info', count(Globals::$person->getProjects_Done(1)), 0, count(Globals::$person->getProjects()));
